...
class ProfileEditController extends GetxController{
  ...
  Future<void> pickImage() async {
    ...
    profilePic.value=(await imagePicker.pickImage(source: ImageSource.gallery));
  }
  ...
  Future<void> updateProfile() async{
    try {
      ...
      UserService.userModel = UserModel(userName: userNameController.text, accountType: UserService.userModel.accountType, email: UserService.userModel.email, emailVerified: UserService.userModel.emailVerified, cnic: int.tryParse(cnicController.text),lat:position?.latitude,
      lng: position?.longitude,
        profileImgUrl: downloadUrl
      );
    }
