            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  20.verticalSpace,
                  CustomTextField(controller: loginController.loginPassCont, validator: loginController.passValidation, label: "Password", suffix: Icon(Icons.lock, size: 25.h,),hint: "Enter password here"),
                  20.verticalSpace,
                  Row(
