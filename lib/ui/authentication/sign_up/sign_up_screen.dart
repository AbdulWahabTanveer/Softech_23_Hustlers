            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  40.verticalSpace,
                  CustomTextField(controller: signUpController.nameCont, validator: signUpController.nameValidation, label: "Name", suffix: Icon(Icons.email, size: 25.h,), hint: "Enter Full name", ),
                  20.verticalSpace,
